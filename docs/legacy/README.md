> **Legacy documentation:** This file preserves the repository's former root README for historical context. It describes an older MongoDB-era setup and should not be used as the authoritative guide for the current repository. Use the [current README](../../README.md) for setup and verified project information.
>
> **Security note:** A plaintext legacy database credential was removed while archiving this document. Credentials must never be committed to source control.
...
MONGODB_URI=<redacted-legacy-credential>
